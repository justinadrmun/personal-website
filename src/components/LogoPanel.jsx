	...
	return (
			<div className="logo-container">
				<div className="logo-link-container">
					<a 
						href="https://linkedin.com/in/jm-ds"
						className="bg-stone-400 logo-link-1"
						target="_blank"
					...
					<a 
						href="https://github.com/justinadrmun"
						className="bg-stone-400 logo-link-2"
						target="_blank"
						rel="noopener noreferrer">
						<svg
							xmlns="http://www.w3.org/2000/svg"
					...
					<a 
						href="https://scholar.google.com/citations?user=YVHjRXoAAAAJ&hl=en"
						className="bg-stone-400 logo-link-3"
						target="_blank"
						rel="noopener noreferrer">
						<svg
							xmlns="http://www.w3.org/2000/svg"
							role="img"
							className="logo-svg-3"
							viewBox="0 0 24 24"
						>
							<path 
					...
					<a 
						href="mailto:justinadrmun@gmail.com"
						className="bg-stone-400 logo-link-4"
						target="_blank"
						rel="noopener noreferrer">
						<svg 
							viewBox="0 0 8 6" 
